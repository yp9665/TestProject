...
var ControllerMetadataRequest = /** @class */ (function () {
    ...
    ControllerMetadataRequest.prototype.run = function () {
        ...
        this.controller.log("Setting metadata for AssetId:  ".concat(this.controller.uploadData.assetId));
        this.controller.log("File name: ".concat(this.controller.uploadData.file.name));
        this.controller.log("File size: ".concat(this.controller.uploadData.file.size));
        this.controller.log("CorrelationId: ".concat(this.controller.uploadData.correlationId));
        this.controller.log("ContentType: ".concat(contentType));
        ...
        (0, request_1.default)({
            ...
            onError: function (error) {
                ...
                _this.controller.log("Set metadata failed: AssetId: ".concat(_this.controller.uploadData.assetId, ", StatusCode: ").concat(eventStatusCode, ", errorMessage: ").concat(error.message));
    ...
    ControllerMetadataRequest.prototype.onSetMetaDataSuccess = function (response) {
        ...
        this.controller.log("ChunkSize: ".concat(response.data.chunk_size));
        ...
        this.controller.log("Chunks to upload: ".concat(this.controller.uploadData.totalBlocks));
        (0, telemetry_1.trackEvent)('setMetaDataSuccess', {
        ...
        if (response.data.resume_restart) {
            ...
            this.controller.log("Chunks remaining to upload: ".concat(remainingChunksToUpload));
