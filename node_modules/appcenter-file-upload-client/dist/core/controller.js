...
var FileUploadController = /** @class */ (function () {
    ...
    FileUploadController.prototype.fatalError = function (errorMessage, data) {
        ...
        (0, telemetry_1.trackError)(errorMessage, data);
    ...
    FileUploadController.prototype.log = function (information) {
        if (this.uploadData.logToConsole === true) {
            console.log("".concat((0, utils_1.timeStamp)(), ": ").concat(information));
        }
        if (this.uploadData.onMessage) {
    ...
    FileUploadController.prototype.setState = function (state) {
        ...
        this.log("Setting state: ".concat(types_1.FileUploadServiceState[state], " (").concat(state, ")"));
    ...
    FileUploadController.prototype.reportChunkProgress = function () {
        ...
        this.uploadStatus.averageSpeed = (0, metrics_1.calculateAverageSpeedWithChunks)(this.uploadStatus.startTime, this.uploadStatus.blocksCompleted, this.uploadData.chunkSize);
        ...
        if (timeRemainingIsInvalid) {
            this.log("something went wrong averageSpeed is 0 but the dataRemaining is: ".concat(this.uploadStatus.chunkQueue.length * this.uploadData.chunkSize));
        }
        var timeRemaining = (0, metrics_1.calculateTimeRemainingWithChunks)(this.uploadData.totalBlocks - this.uploadStatus.blocksCompleted, this.uploadData.chunkSize, this.uploadStatus.averageSpeed);
        var progress = {
    ...
    FileUploadController.prototype.reportEventProgress = function (chunkNumber, bytesUploadedInChunk) {
        ...
        if (difference > 0) {
            ...
            var averageSpeed = (0, metrics_1.calculateAverageSpeed)(this.uploadStatus.startTime, this.totalBytesUploaded);
            var bytesRemaining = this.uploadData.file.size - this.totalBytesUploaded;
            var timeRemaining = (0, metrics_1.calculateTimeRemaining)(bytesRemaining, averageSpeed);
            var progress = {
                percentCompleted: parseFloat(percentCompleted.toFixed(2)),
    ...
    FileUploadController.prototype.initializeUpload = function (uploadData) {
        ...
        this.uploadStatus = (0, init_state_1.getInitialUploadStatus)();
        // Copy all the required settings on to the upload data.
        this.uploadData = (0, init_state_1.getInitialUploadData)(uploadData);
        this.setState(types_1.FileUploadServiceState.New);
        (0, telemetry_1.trackEvent)("UploadInitialized", { AssetId: this.uploadData.assetId, CorrelationId: this.uploadData.correlationId });
