...
var SingleThreadUploadController = /** @class */ (function (_super) {
    ...
    SingleThreadUploadController.prototype.upload = function () {
        ...
        (0, utils_1.getChunk)(chunkNumber, this.uploadData)
    ...
    SingleThreadUploadController.prototype.uploadChunk = function (chunk, chunkNumber) {
        ...
        this.runningUploadRequests[chunkNumber] = (0, request_1.default)({
            method: 'POST',
            async: true,
            chunk: chunk,
            ...
            onError: function (error) {
                ...
                _this.log("Failed to upload chunk: ".concat(_this.uploadData.assetId, " chunkNumber: ").concat(chunkNumber));
            ...
            onSuccess: function (response) {
                delete _this.runningUploadRequests[chunkNumber];
                if (response.error) {
                    _this.log("Failed to upload chunk: ".concat(_this.uploadData.assetId, " chunkNumber: ").concat(chunkNumber, " retrying..."));
                    _this.uploadStatus.chunkQueue.push(chunkNumber);
                    _this.upload();
                }
                else {
                    (0, telemetry_1.trackEvent)("uploadChunkSuccess", {
                        chunkNumber: chunkNumber,
