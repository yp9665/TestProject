...
import { isWorkletFunction, makeShareableCloneRecursive, runOnUI, shareableMappingCache } from 'react-native-worklets';
...
const IN_STYLE_UPDATER_UI = makeShareableCloneRecursive({
  current: false
});
