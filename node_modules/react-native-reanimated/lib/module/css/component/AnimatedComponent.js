...
import { CSSManager } from "../managers/index.js";
import { markNodeAsRemovable, unmarkNodeAsRemovable } from "../platform/native/index.js";
...
export default class AnimatedComponent extends Component {
  ...
  render(props) {
    ...
    return <ChildComponent {...this.props} {...props} {...platformProps} style={filterNonCSSStyleProps(props?.style ?? this.props.style)}
