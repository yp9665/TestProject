...
import { registerCSSKeyframes, unregisterCSSKeyframes } from "../platform/native/index.js";
/**
...
class CSSKeyframesRegistry {
  ...
  add(keyframesRule, viewTag) {
    ...
    if (existingEntry) {
      ...
      registerCSSKeyframes(keyframesRule.name, keyframesRule.normalizedKeyframesConfig);
    }
  }
  remove(animationName, viewTag) {
