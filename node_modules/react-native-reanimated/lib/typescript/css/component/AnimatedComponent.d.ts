...
import type { AnimatedComponentRef, ViewInfo } from '../../createAnimatedComponent/commonTypes';
...
export default class AnimatedComponent<P extends AnyRecord = AnimatedComponentProps> extends Component<P> {
